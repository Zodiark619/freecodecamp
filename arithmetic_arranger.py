    ...
    try:
        ...
        if b:
            ...
            for bubu in num1:
                ...
                counter+=1
            print(' ')
    except meong2 as meong2:
        print('Error: Too many problems.')
    except meong3 as meong3:
        print("Error: Operator must be '+' or '-'.")
    except meong4 as meong4:
        print('Error: Numbers must only contain digits.')
    except meong5 as meong5:
        print('Error: Numbers cannot be more than four digits.')



# arithmetic_arranger(['1200 + 13','23 - 69','2433 + 69','2553 - 69','3223 - 69'],True)
